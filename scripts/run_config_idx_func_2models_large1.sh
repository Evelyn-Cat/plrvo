...
for modelname in "${array_modelname[@]}"; do
    ...
    bash running_config_idx_lr.sh $gpu_id $per_device_train_batch_size $taskname $modelname $noise_type $config_idx $batch_size $output_dir
    wait
done

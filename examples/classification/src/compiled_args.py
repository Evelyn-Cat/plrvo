...
class PrivacyArguments:
    ...
    noise_type: str = field(
        default="Gaussian", metadata={
            "help": "Choose from: Gaussian, Laplace, PLRVO and non"
        }
    )

    config_idx: Optional[int] = field(
        default=None, metadata={
            "help": "index of the prlvo noise parameters, locaed in plrvo/configs/{config_idx}.json"
        }
    )
